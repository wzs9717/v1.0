...
public class SuperController : MonoBehaviour
{
	...
	//process ctrollers detail, the player controller Sphere?
	{
	...
	//highlight your target when you are looking at it and select it
	{
	...
	// seems this is the controller below the atom
	{
	...
	//control the crontroller to up/down/trun/rotation
	{
	...
	//VR controller init
	{
		...
		{
			if (OVRRig != null)//OVRRig seems the VR input
			{
	...
	private void Update()
	{
		...
		ProcessControllerNavigation();//navigation is  UI in vam
		if (!onStartScene)
		{
			ProcessUI();//show UI
